...
# Exercise-2 TODOs:
    ...
    pcl.save(cloud, "PR2_POINTCLOUD.pcd")
    ...
    cluster_ex.set_MinClusterSize(15)
    cluster_ex.set_MaxClusterSize(1500)
...
# Exercise-3 TODOs:
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        label_pos[2] += .4
        obj_markers_pub.publish(make_label(label,label_pos, index))
...
if __name__ == '__main__':
    ...
    obj_markers_pub = rospy.Publisher("/object_markers", Marker, queue_size=1)
